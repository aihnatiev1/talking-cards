...
const _audioMap = {
  ...
  // UA — Poems (full-poem audio, no word-cutoff — plays naturally to end)
  'poem_vedmid': 'poem_vedmid',
  'poem_vovk': 'poem_vovk',
  'poem_vivtsia_korova': 'poem_vivtsia_korova',
  'poem_husak_kurka': 'poem_husak_kurka',
  'poem_husak': 'poem_husak',
  'poem_dytia_porosia': 'poem_dytia_porosia',
  'poem_giraffe_zebra': 'poem_giraffe_zebra',
  'poem_turkey': 'poem_turkey',
  'poem_duck': 'poem_duck',
  'poem_duck2': 'poem_duck2',
  'poem_goat_kid': 'poem_goat_kid',
  'poem_horse': 'poem_horse',
  'poem_little_cow': 'poem_little_cow',
  'poem_rabbit': 'poem_rabbit',
  'poem_rabbit2': 'poem_rabbit2',
  'poem_hen': 'poem_hen',
  'poem_fox': 'poem_fox',
  'poem_kitty': 'poem_kitty',
  'poem_rhino': 'poem_rhino',
  'poem_sheep': 'poem_sheep',
  'poem_eagle': 'poem_eagle',
  'poem_parrot': 'poem_parrot',
  'poem_puppy': 'poem_puppy',
  'poem_fish': 'poem_fish',
  'poem_pig': 'poem_pig',
  'poem_owl': 'poem_owl',
  'poem_tiger': 'poem_tiger',
  'poem_turtle': 'poem_turtle',
  // Забавлянки — full action rhymes, keys match mp3 filenames 1:1
  'rhyme_baraban': 'rhyme_baraban',
  'rhyme_baran_buts': 'rhyme_baran_buts',
  'rhyme_behemotyk': 'rhyme_behemotyk',
  'rhyme_vidpochynok': 'rhyme_vidpochynok',
  'rhyme_horobtsi': 'rhyme_horobtsi',
  'rhyme_husy': 'rhyme_husy',
  'rhyme_yizhachok': 'rhyme_yizhachok',
  'rhyme_yikhav_pan': 'rhyme_yikhav_pan',
  'rhyme_kapusta': 'rhyme_kapusta',
  'rhyme_kenhuru': 'rhyme_kenhuru',
  'rhyme_kozenia': 'rhyme_kozenia',
  'rhyme_kuiu_chobitok': 'rhyme_kuiu_chobitok',
  'rhyme_leleky': 'rhyme_leleky',
  'rhyme_lichylochka': 'rhyme_lichylochka',
  'rhyme_maliata_blyzniata': 'rhyme_maliata_blyzniata',
  'rhyme_masazhyk': 'rhyme_masazhyk',
  'rhyme_myshka': 'rhyme_myshka',
  'rhyme_mlyntsi': 'rhyme_mlyntsi',
  'rhyme_molodtsi': 'rhyme_molodtsi',
  'rhyme_okh_okh': 'rhyme_okh_okh',
  'rhyme_pechu_khlibchyk': 'rhyme_pechu_khlibchyk',
  'rhyme_pyrih': 'rhyme_pyrih',
  'rhyme_podolianochka': 'rhyme_podolianochka',
  'rhyme_praportsi': 'rhyme_praportsi',
  'rhyme_tanok': 'rhyme_tanok',
  'rhyme_chempion': 'rhyme_chempion',
  // Абетка — letter-only + rhyme clips, keys match mp3 filenames 1:1
  'abc_letter_a': 'abc_letter_a',
  'abc_letter_b': 'abc_letter_b',
  'abc_letter_v': 'abc_letter_v',
  'abc_letter_h': 'abc_letter_h',
  'abc_letter_g': 'abc_letter_g',
  'abc_letter_d': 'abc_letter_d',
  'abc_letter_e': 'abc_letter_e',
  'abc_letter_ye': 'abc_letter_ye',
  'abc_letter_zh': 'abc_letter_zh',
  'abc_letter_z': 'abc_letter_z',
  'abc_letter_y': 'abc_letter_y',
  'abc_letter_i': 'abc_letter_i',
  'abc_letter_yi': 'abc_letter_yi',
  'abc_letter_yot': 'abc_letter_yot',
  'abc_letter_k': 'abc_letter_k',
  'abc_letter_l': 'abc_letter_l',
  'abc_letter_m': 'abc_letter_m',
  'abc_letter_n': 'abc_letter_n',
  'abc_letter_o': 'abc_letter_o',
  'abc_letter_p': 'abc_letter_p',
  'abc_letter_r': 'abc_letter_r',
  'abc_letter_s': 'abc_letter_s',
  'abc_letter_t': 'abc_letter_t',
  'abc_letter_u': 'abc_letter_u',
  'abc_letter_f': 'abc_letter_f',
  'abc_letter_kh': 'abc_letter_kh',
  'abc_letter_ts': 'abc_letter_ts',
  'abc_letter_ch': 'abc_letter_ch',
  'abc_letter_sh': 'abc_letter_sh',
  'abc_letter_shch': 'abc_letter_shch',
  'abc_letter_soft': 'abc_letter_soft',
  'abc_letter_yu': 'abc_letter_yu',
  'abc_letter_ya': 'abc_letter_ya',
  'abc_rhyme_a': 'abc_rhyme_a',
  'abc_rhyme_b': 'abc_rhyme_b',
  'abc_rhyme_v': 'abc_rhyme_v',
  'abc_rhyme_h': 'abc_rhyme_h',
  'abc_rhyme_g': 'abc_rhyme_g',
  'abc_rhyme_d': 'abc_rhyme_d',
  'abc_rhyme_e': 'abc_rhyme_e',
  'abc_rhyme_ye': 'abc_rhyme_ye',
  'abc_rhyme_zh': 'abc_rhyme_zh',
  'abc_rhyme_z': 'abc_rhyme_z',
  'abc_rhyme_y': 'abc_rhyme_y',
  'abc_rhyme_i': 'abc_rhyme_i',
  'abc_rhyme_yi': 'abc_rhyme_yi',
  'abc_rhyme_yot': 'abc_rhyme_yot',
  'abc_rhyme_k': 'abc_rhyme_k',
  'abc_rhyme_l': 'abc_rhyme_l',
  'abc_rhyme_m': 'abc_rhyme_m',
  'abc_rhyme_n': 'abc_rhyme_n',
  'abc_rhyme_o': 'abc_rhyme_o',
  'abc_rhyme_p': 'abc_rhyme_p',
  'abc_rhyme_r': 'abc_rhyme_r',
  'abc_rhyme_s': 'abc_rhyme_s',
  'abc_rhyme_t': 'abc_rhyme_t',
  'abc_rhyme_u': 'abc_rhyme_u',
  'abc_rhyme_f': 'abc_rhyme_f',
  'abc_rhyme_kh': 'abc_rhyme_kh',
  'abc_rhyme_ts': 'abc_rhyme_ts',
  'abc_rhyme_ch': 'abc_rhyme_ch',
  'abc_rhyme_sh': 'abc_rhyme_sh',
  'abc_rhyme_shch': 'abc_rhyme_shch',
  'abc_rhyme_soft': 'abc_rhyme_soft',
  'abc_rhyme_yu': 'abc_rhyme_yu',
  'abc_rhyme_ya': 'abc_rhyme_ya',
};
